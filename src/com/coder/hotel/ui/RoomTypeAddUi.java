...
public class RoomTypeAddUi extends JFrame {
    ...
    private void initComponents() {
        ...
        JTextArea remarkTextArea = new JTextArea(); // 创建 JTextArea
        remark = new JScrollPane(remarkTextArea); // 将 JTextArea 添加到 JScrollPane 中
        okBtn = new JButton();
        ...
        //======== panel1 ========
        {
            ...
            panel1.add(remark);
            remark.setBounds(90, 175, 280, 100);
